"use client"
import { RepeatedPasswordChartProps } from "./RepeatesPasswordChart.types";
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        <CardTitle>Passwords repeated vs unique</CardTitle>
        <CardDescription>Review your repeated passwords</CardDescription>
      </CardHeader>
